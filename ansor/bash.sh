...
#    -v ${SCRIPT_DIR}:/docker \
#    -w /workspace \
export CI_BUILD_HOME=/workspace
export CI_BUILD_USER=$(id -u -n)
export CI_BUILD_UID=$(id -u)
export CI_BUILD_GROUP=$(id -g -n)
export CI_BUILD_GID=$(id -g)
export PYTHONPATH=/workspace/python:/workspace/topi/python
export CI_PYTEST_ADD_OPTIONS=$CI_PYTEST_ADD_OPTIONS
